...
pub struct PaletteSwapPostProcessPlugin;

impl Plugin for PaletteSwapPostProcessPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins((
            ...
            ExtractComponentPlugin::<PaletteSwapPostProcessSettings>::default(),
...
impl ViewNode for PostProcessNode {
    ...
    type ViewQuery = (
        ...
        &'static PaletteSwapPostProcessSettings,
        // As there could be multiple post processing components sent to the GPU (one per camera),
        // we need to get the index of the one that is associated with the current view.
        &'static DynamicUniformIndex<PaletteSwapPostProcessSettings>,
    );
    ...
    fn run(
        ...
        let settings_uniforms = world.resource::<ComponentUniforms<PaletteSwapPostProcessSettings>>();
...
impl FromWorld for PostProcessPipeline {
    fn from_world(world: &mut World) -> Self {
        ...
        let layout = render_device.create_bind_group_layout(
            ...
            &BindGroupLayoutEntries::sequential(
                ...
                (
                    ...
                    uniform_buffer::<PaletteSwapPostProcessSettings>(true),
                ),
            ),
        );
        ...
        let shader = world.load_asset("shaders/palette_swap.wgsl");
